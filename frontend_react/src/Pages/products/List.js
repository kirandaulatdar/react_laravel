...
function ProductList({ userData,handleOpenModal,handleEdit }) {
 ...
 return (
    <div className="main">
            <div className="main-content">
                    <div className=" bold ft-23 mb-3">Products List</div>
                    <div className="row justify-content-end align-items-end">
                    {localStorage.getItem('role') == 'Admin' && ( 
                     <div className="col-12 mb-3 col-md-12 col-lg-4 col-xl-6">
                        <button className="btn btn-theme" data-bs-toggle="modal" data-bs-target="#addproductModal">+ Add Product</button>
                     </div>
                      )}
